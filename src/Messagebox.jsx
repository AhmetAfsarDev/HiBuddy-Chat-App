        ...
        <ul className='Activeuserlist' >
          ...
          <li className='Activeuser' >
            ...
            <div className='Profileinfo'>
              {/* Projenin derlenirken hata vermemesi için public yolu düzeltildi */}
              <img className='Userprofilephoto' src="/ProfilPicture.png" alt="pp"></img>
        ...
        <div className='Messagewrapper'>
          <ul className='Messagelistwrapper' >
                <li className='MMessage'>
                  <div><img className='Userprofilephoto' src="/ProfilPicture.png" alt="pp"></img> <span className='Username' >Ahmet</span></div>
